...
class client_encryption {
   public:
    ...
    ///
    /// @return The id of the created document as a UUID (BSON binary subtype 4).
    ///
    /// @throws mongocxx::exception when there are errors creating the key.
    ///
    /// @see
    /// https://docs.mongodb.com/ecosystem/use-cases/client-side-field-level-encryption-guide/#b-create-a-data-encryption-key
    ///
    bsoncxx::types::b_binary create_data_key(std::string kms_provider,
    ...
    /// @param opts
    ///   Optional arguments, see options::encrypt.
    ///
    ...
    ///
    // bsoncxx::types::value encrypt(const bsoncxx::types::value& value, const options::encrypt&
    // opts);
    ...
    ///
    // bsoncxx::types::value decrypt(const bsoncxx::types::value& value);

   private:
    // TODO move this to an impl instead.
